...
describe('Apply_filters', () => {
    ...
    beforeEach( ()=>{
        //go to goals page from Nama' Salameh account before each test case
    ...
    it('List of Goal Filter' , ()=>{
        ...
        //test if "Topic 1" checkbox exists and not checked
        ...
        //test if "Topic 2" checkbox exists and not checked
